...
#define BG_TEX_FULE		"data\\TEXTURE\\AKIRA.ng"			//奥背景の画像を読み込む
...
void InitPolygon(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, BG_TEX_FULE, &g_pTexturePolygon);
...
void DrawPolygon(void)
{
	...
	//頂点バッファをデータストリームに設定
	pDevice->SetStreamSource(0, g_pVtxBuffPolygon, 0,
